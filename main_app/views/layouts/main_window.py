...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.stream_window.setFont(font)
        self.stream_window.setStyleSheet("color: #ffc933; font-size: 32px")
        self.stream_window.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.gridLayout.addWidget(self.stream_window, 0, 0, 1, 3, QtCore.Qt.AlignCenter)
